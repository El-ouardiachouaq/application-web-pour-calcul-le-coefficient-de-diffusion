...
def home():
    return '''
    <h1>Projet de calcul du coefficient de diffusion D<sub>AB</sub></h1>
    <p>Cliquez <a href="/coeff-diffusion">ici</a> pour accéder au calculateur de coefficient de diffusion.</p>
    '''
